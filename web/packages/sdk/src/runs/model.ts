...
const runWaitDefinition = z.object({ id: z.string(), kind: z.string().optional(), node: z.string(), nodePath: z.string().optional(), occurrenceId: z.string().optional(), config: jsonObjectSchema }).catchall(jsonValueSchema);
