...
const localContext = inheritedContext
  ...
  : usePromptInputProvider({
      initialInput: props.modelValue ?? props.initialInput,
...
watch(() => props.modelValue, value => {
  if (value !== undefined && value !== context.textInput.value) context.setTextInput(value)
})
watch(context.textInput, value => emit('update:modelValue', value))
