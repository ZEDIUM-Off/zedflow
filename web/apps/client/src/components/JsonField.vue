...
function update(value:string){text.value=value;try{emit('update:modelValue',JSON.parse(value));error.value=''}catch{error.value='JSON invalide · dernière valeur valide conservée'}}
</script>
