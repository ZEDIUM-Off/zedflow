...
#[test]
#[ignore = "parity blocker: live Xiaomi Token Plan Anthropic transport and replay payload capture are not ported"]
fn preserves_empty_thinking_signature_for_replay() {
    ...
    assert!(matches!(error, Error::PortPlaceholder(_)));
}
