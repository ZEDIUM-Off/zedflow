...
pub fn strategy() -> ContextStrategy {
    ContextStrategy::new_v2("working-system-context", "Working System · documentation")
        ...
        .capability(ContextCapability::new("read", DataType::Record { fields: BTreeMap::from([]) }, DataType::Record { fields: BTreeMap::from([]) }))
        .capability(ContextCapability::new("exec", DataType::Record { fields: BTreeMap::from([]) }, DataType::Record { fields: BTreeMap::from([]) }))
        .with_program(vec![
